...
export default function AdminSidebar({ userName }: AdminSidebarProps) {
  return (
    <div className="w-64 bg-yellow-400 shadow-md p-6 flex flex-col">
      <div className="mb-4">
      ...
      <nav className="space-y-2">
        <Link href="/admin" className="flex items-center gap-2 py-2 px-4 bg-yellow-100 text-black rounded font-medium">
        ...
        <Link href="#" className="flex items-center gap-2 py-2 px-4 text-gray-700 hover:bg-gray-100 rounded">
          <span className="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="h-5 w-5 mr-2 bi bi-people" viewBox="0 0 16 16">
        ...
        <Link href="#" className="flex items-center gap-2 py-2 px-4 text-gray-700 hover:bg-gray-100 rounded">
          <span className="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="h-5 w-5 mr-2 bi bi-gear" viewBox="0 0 16 16">
